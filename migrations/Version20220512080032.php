 ...
 */
final class Version20220512080032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP FOREIGN KEY fk-user');
        $this->addSql('DROP INDEX fk-user ON comments');
        $this->addSql('ALTER TABLE comments CHANGE user_id user_id INT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE trick_id trick_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE videos DROP FOREIGN KEY FK-trick');
        $this->addSql('DROP INDEX FK-trick ON videos');
    }
