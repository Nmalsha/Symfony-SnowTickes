 ...
 */
final class Version20220507210618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD trick_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP trick_id, CHANGE user_id user_id INT DEFAULT NULL');
